...
#define LOG_LEVEL_DO_PARSE     1
#define LOG_LEVEL_DO_NOT_PARSE 0

LOGLEVEL_MAP(LOG_ANY,    -1, ' ', LOG_LEVEL_DO_NOT_PARSE) /* not in sys/syslog.h */
LOGLEVEL_MAP(LOG_EMERG,   0, '!', LOG_LEVEL_DO_PARSE)
LOGLEVEL_MAP(LOG_ALERT,   1, 'A', LOG_LEVEL_DO_PARSE)
LOGLEVEL_MAP(LOG_CRIT,    2, 'C', LOG_LEVEL_DO_PARSE)
LOGLEVEL_MAP(LOG_ERR,     3, 'E', LOG_LEVEL_DO_PARSE)
LOGLEVEL_MAP(LOG_WARNING, 4, 'W', LOG_LEVEL_DO_PARSE)
LOGLEVEL_MAP(LOG_NOTICE,  5, 'N', LOG_LEVEL_DO_PARSE)
LOGLEVEL_MAP(LOG_INFO,    6, 'I', LOG_LEVEL_DO_PARSE)
LOGLEVEL_MAP(LOG_DEBUG,   7, 'D', LOG_LEVEL_DO_PARSE)
LOGLEVEL_MAP(LOG_UNKNOWN, 8, '-', LOG_LEVEL_DO_NOT_PARSE) /* not in sys/syslog.h */

#undef LOG_LEVEL_DO_PARSE
#undef LOG_LEVEL_DO_NOT_PARSE
